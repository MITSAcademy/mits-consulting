      ...
      <Page>
        ...
        {isError ? (
          ...
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5 mb-4">
              <Kpi icon={Users}         label="Active clients"   value={data.ops.activeClientsWithStub ?? data.ops.activeClients} rawValue={data.ops.activeClientsWithStub ?? data.ops.activeClients} sub={`${data.ops.holds} on hold`} accent="blue" delay={0}   to="/clients" />
