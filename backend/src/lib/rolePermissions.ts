...
export const RESOURCE_MATRIX: Record<string, { label: string; defaultRoles: string[] }> = {
  ...
  'tasks.read':              { label: 'Tasks: View',                 defaultRoles: ['founder', 'manager', 'lead', 'account_manager', 'demo_lead', 'accounts', 'demo_intake', 'recruiter', 'sales_closer', 'staff'] },
  'tasks.write':             { label: 'Tasks: Create/Edit',          defaultRoles: ['founder', 'manager', 'lead', 'account_manager', 'demo_lead', 'accounts', 'demo_intake', 'recruiter', 'sales_closer', 'staff'] },
