...
<div style="max-width:600px;margin:24px auto;background:#ffffff;border:1px solid #e0e0e0;border-radius:8px;overflow:hidden;">
  <div style="padding:32px 36px;color:#1a1a1a;font-size:15px;line-height:1.7;">
    ...
    <p style="margin:0 0 16px;">Your <span style="background:#fff8e1;font-weight:bold;">feedback</span> is vital to us, and we would be incredibly grateful if you could take a few minutes to complete our survey form. This form has been designed to gather your valuable insights and opinions on your experience with our company.</p>

    <p style="text-align:center;margin:24px 0;">
      <a href="${FORM_URL}" style="display:inline-block;background:#1a1a2e;color:#ffffff !important;text-decoration:none;padding:14px 32px;border-radius:6px;font-weight:700;font-size:15px;letter-spacing:0.3px;">📋 Fill Client Survey Form</a>
    </p>
    ...
    <div style="font-size:13px;color:#444;">
      ...
      <div style="font-size:17px;font-weight:700;color:#1a1a1a;margin-bottom:6px;font-family:Georgia,serif;font-style:italic;">${mitaliName}</div>
      ...
      <div style="font-size:26px;font-weight:900;color:#1a1a1a;letter-spacing:-1px;">MITS</div>
      <div style="font-size:11px;color:#888;letter-spacing:1px;text-transform:uppercase;">Solution</div>
      <div style="font-size:13px;color:#888;font-style:italic;margin-top:8px;">🏆 MITS Solution got awarded as one of the top Ed'Tech Firms in 2022</div>
