...
import { dateChangeRequestsRouter } from './routes/dateChangeRequests';
...
import { feedbackPunchRouter } from './routes/feedbackPunches';
...
import { integrityCheckRouter } from './routes/integrityCheck';
...
app.use('/api/resume-sanitise', resumeSanitiseRouter);
app.use('/api/messages', messagesRouter);
app.use('/api/calendar', calendarRouter);
app.use('/api/oauth', oauthRouter);
app.use('/api/ai', aiRouter);
app.use('/api/follow-up-payments', followUpPaymentsRouter);
app.use('/api/date-change-requests', dateChangeRequestsRouter);
...
app.use('/api/feedback-punches', feedbackPunchRouter);
...
app.use('/api/integrity-check', requireAuth, integrityCheckRouter);
